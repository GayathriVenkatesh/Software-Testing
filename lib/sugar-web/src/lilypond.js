...
//                     // logo.notation.notationStaging[turtle][i + j][4];
//                 j++; // Jump to next note.
...
//     function processLilypondNotes(lilypond, logo, turtle, obj, flag, mode, arr=[0,0], word="", isComplete=true) {
//         // obj = [instructions] or
...
//                                 const thisScale = ["C", "D", "E", "F", "G", "A", "B"];
//                                 obj = [thisScale, ["do", "re", "mi", "fa", "sol", "la", "ti"], "C", "major"]
//                                 let modeDef = "\n" + mode.replace(/ /g, "_") + " = #`("; // "\n = #`("
//                                 let prevNote = "";
//                                 let n, nn = -1;
...
//                         logo.notationNotes[turtle] += "\n";
//                     }
//                     // logo.notationNotes[turtle] = "taylor";
//                     noteCounter += 1;

//                     /* eslint-disable no-unused-vars */
//                     if (typeof obj[0] === "string") {
//                         note = __toLilynote(obj[0]);  // test
//                     } 
//                     else {
//                         notes = obj[0];
...
//                             tupletNoteCounter = 1;
//                         } else if (arr[0] > commonTupletNote) {
//                             f = arr[0] / commonTupletNote;
//                             commonTupletNote = arr[0];
//                             tupletNoteCounter *= f;
//                             tupletNoteCounter += 1;
//                         }
...
// module.exports = { getLilypondHeader,  __toLilynote, processLilypondNotes, saveLilypondOutput, __processTuplet };